...
public class HttpServletRequestJavax extends ServletRequestJavax implements HttpServletRequest {
	...
	/*
	 * @Override public <T extends HttpUpgradeHandler> T upgrade(Class<T> handlerClass) throws
	 * IOException, ServletException { throw new RuntimeException("method [upgrade] is not supported");
	 * 
	 * }
	 */
}
