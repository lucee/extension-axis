...
public class ClassUtil {
	...
	public static String createId(String wsdlUrl, String username, String password, ProxyData proxyData, String methodName, Object[] arguments, Struct namedArguments)
		...
		try {
			...
			Method m = clazz.getMethod("createId", new Class[] { String.class, String.class, String.class, ProxyData.class, String.class, Object[].class, Struct.class });
			return engine.getCastUtil().toString(m.invoke(null, new Object[] { wsdlUrl, username, password, proxyData, methodName, arguments, namedArguments }));
		}
		catch (Exception e) {
			throw caster.toPageException(e);
		}
